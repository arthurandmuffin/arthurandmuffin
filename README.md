...
* Crawlr:
    * A Bar Crawl management system for McGill Engineering bar crawls! Dynamic routing to minimize congestion at bars! 🍻

## Things I worked on (in no particular order) 📚
...
* MsPacman-RL
    ...
    * Courtesy to the Atari Learning Environment simulator ([ALE](https://github.com/Farama-Foundation/Arcade-Learning-Environment)).
* TissueTrackr
